...
bool CConnman::AttemptToEvictConnection()
{
    ...
    // An attacker cannot buenpulate this metric without physically moving nodes closer to the target.
    ...
    // An attacker cannot buenpulate this metric without performing useful work.
